            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="text-center mb-20 max-w-4xl mx-auto">
                    <h2 className={`${playfair.className} text-3xl md:text-5xl lg:text-6xl font-extrabold mb-8 text-blue-950 leading-tight break-words`}>
                        {isPremium ? (
                            <>
                                Ammattimainen ja myyvä verkkosivusto <span className="text-blue-600">ilman monimutkaisia prosesseja.</span>
                            </>
                        ) : (
                            <>
                    ...
                    <p className="text-xl md:text-2xl text-slate-600 leading-relaxed">
                        Nettisivu ei ole menoerä. Se on paras työntekijäsi, joka ei nuku koskaan. Selkeällä hinnoittelulla ilman piilokuluja.
                    </p>
                </div>
                    ...
                    <div className="text-center w-full">
                        {isPremium ? (
                            <h3 className={`${playfair.className} text-3xl md:text-4xl font-bold text-blue-900 mb-6`}>
                                Verkkosivuston suunnittelu ja käyttöönotto alkaen {preset.starterSetup} <span className="text-xl font-normal text-slate-500 lowercase">(+ alv)</span>
                                <span className="text-xl md:text-2xl text-slate-500 font-normal mt-2 block">Pohjana valmiiksi optimoitu ja testattu rakenne, joka räätälöidään yrityksellesi</span>
                            </h3>
                        ) : (
                            <h3 className={`${playfair.className} text-3xl md:text-4xl font-bold text-blue-900 mb-6`}>
                                Mitä saat alkaen {preset.basicAnnual}/kk + alv* + sivuston rakennus {preset.starterSetup} + alv? <br />
                ...
                <div className="mb-24 bg-slate-50 border border-slate-200/60 rounded-3xl p-6 md:p-8 max-w-4xl mx-auto shadow-sm">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 items-stretch">
                        <div className="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-sm flex flex-col hover:shadow-md transition-shadow">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h5 className="font-bold text-slate-900 text-lg">🛠️ Sivuston rakennus (alkaen {preset.starterSetup} + alv)</h5>
                            </div>
                        ...
                        <div className="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-sm flex flex-col hover:shadow-md transition-shadow">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h5 className="font-bold text-slate-900 text-lg">☁️ Kuukausiylläpito (alkaen {isPremium ? preset.basicAnnual : "33 €"}/kk + alv)</h5>
                            </div>
                            <p className="text-slate-600 text-sm md:text-base leading-relaxed flex-grow">
                                Kattaa <strong>huippunopean palvelimen (hosting), SSL-salausturvan, automaattiset varmuuskopiot, jatkuvan laadunvalvonnan ja tarvittavat tekniset päivitykset</strong>. Sivusi pysyy aina turvassa ja toiminnassa ilman omaa vaivaasi.
                            </p>
                        </div>
                    </div>
                    <div className="mt-6 pt-4 border-t border-slate-100 text-center text-slate-700 text-sm md:text-base font-medium">
                        {isPremium ? (
                            <>
                                👉 <strong>Teemme kanssasi aina maksuttoman 15 minuutin arviointipuhelun, jossa katsomme tarpeesi ja jonka perusteella annamme sinulle pitävän, kiinteän tarjouksen. Näin maksat vain siitä, mitä todella tarvitset.</strong>
                            </>
                        ) : (
                            <>
