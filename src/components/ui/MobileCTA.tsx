    ...
    return (
        <>
            ...
            <div className="fixed bottom-0 left-0 w-full z-50 p-4 md:hidden bg-gradient-to-t from-white via-white/90 to-transparent pb-6 pt-12 animate-in slide-in-from-bottom-10 fade-in duration-500">
                <Link 
                    href="/tarjous"
                    className="flex items-center justify-center w-full bg-blue-700 hover:bg-blue-800 text-white font-black text-lg py-4 px-6 rounded-2xl shadow-[0_10px_25px_rgba(29,78,216,0.4)] tracking-wide uppercase"
                >
            ...
            <div className="hidden md:flex fixed bottom-0 left-0 w-full z-50 h-12 bg-slate-950/80 backdrop-blur-md border-t border-white/10 items-center justify-center text-white/90 text-sm tracking-wide">
                ...
                <Link 
                    href="/tarjous"
                    className="flex items-center gap-2 bg-blue-700 hover:bg-blue-800 text-white px-5 py-1.5 rounded-full ml-4 transition-all font-black text-xs uppercase tracking-widest shadow-lg shadow-blue-700/30"
                >
